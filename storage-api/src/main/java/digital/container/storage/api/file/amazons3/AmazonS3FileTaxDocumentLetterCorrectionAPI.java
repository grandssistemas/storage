...
import digital.container.service.file.amazons3.AmazonS3FileTaxDocumentLetterCorrectionService;
...
@RestController
@RequestMapping
public class AmazonS3FileTaxDocumentLetterCorrectionAPI {
    private static final String URI_BASE = "/api/amazons3-file/tax-document-letter-correction";

    private final AmazonS3FileTaxDocumentLetterCorrectionService service;

    @Autowired
    public AmazonS3FileTaxDocumentLetterCorrectionAPI(AmazonS3FileTaxDocumentLetterCorrectionService service) {
    ...
    @ApiOperation(value = "amazons3-file-tax-document-letter-correction-upload", notes = "Upload de arquivos que serão salvo na amazons3.")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "amazons3-file-tax-document-letter-correction-uploads", notes = "Uploads de arquivos que serão salvo na amazons3. Limite maximo de 500.")
    @ApiResponses(value = {
